...
public class LivroDAO implements ILivroDAO {
    ...
    public void cadastrarLivro(
        ...
        try (Connection con = new Conexao().conectabBD(); PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public ArrayList<LivroDTO> listarLivros() {
        ...
        try (Connection con = new Conexao().conectabBD(); PreparedStatement ps =
        ...
        } catch (SQLException e) {logger.log(Level.SEVERE, "Erro ao listar livros", e);
        ...
        try (Connection con = new Conexao().conectabBD(); PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    livro = new LivroDTO();
                    livro.setId(rs.getInt("id"));
                    livro.setTitulo(rs.getString("titulo"));livro.setAutor(rs.getString("autor"));
                    livro.setAno_publicacao(rs.getInt("ano_publicacao"));
                }
            }
